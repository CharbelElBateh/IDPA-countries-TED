...
| [04-algorithms.md](04-algorithms.md) | Chawathe (Zhang-Shasha) and Nierman & Jagadish (recursive subtree similarity), including the subtree-containment rule. |
| [05-configuration.md](05-configuration.md) | Annotated reference for `config/pipeline.json`. |
| [06-frontend.md](06-frontend.md) | Flask app, three tabs, D3 tree viz, diff coloring. |
...
- **Status**: end-to-end working — ingestion, tree building, both TED
  algorithms (Chawathe and Nierman & Jagadish), edit-script
  application, three frontend tabs (Countries / Compare / Patch),
  MongoDB caching, 111 passing tests.
